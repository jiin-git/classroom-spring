const baseUrl = "/api/members/student/my-page";
async function getStudentMyPageInfo() {
...
const studentMyPageInfo = getStudentMyPageInfo()
    .then(data => {
...
initializeProfileBtn.addEventListener("click", async function (e) {
    ...
    const requestUrl = "/api/members/student/my-page/profile"
...
updateMyPageForm.addEventListener("submit", async function (e) {
    ...
    const requestUrl = "/api/members/student/my-page"
