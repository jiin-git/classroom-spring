...
//import basic.classroom.dto.PageResponse;
...
//    }
//
//    private PageResponse getPageDto(Long page, Student student) {
//        int pageSize = 10;
//        int showPageUnit = 3;
...
//
//        return new PageResponse(currentPage, endPage, showPageUnit, pageSize);
//    }
//    private PageResponse getPageDto(Long page, Instructor instructor) {
//        int pageSize = 10;
//        int showPageUnit = 3;
...
//    }
//
//    private void addModelToPagingLecturesAndPages(Model model, PageResponse pageResponse, List<Lecture> pagingLectures, List<Integer> showPages) {
//        model.addAttribute("lectures", pagingLectures);
//        model.addAttribute("pages", showPages);
//        model.addAttribute("startPage", pageResponse.getStartPage());
//        model.addAttribute("endPage", pageResponse.getEndPage());
//    }
//
